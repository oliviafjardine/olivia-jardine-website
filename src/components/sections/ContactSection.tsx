...
export default function ContactSection({ isHome = false }: ContactSectionProps) {
  return (
    <section className="flex flex-col items-center mt-10 mb-20 min-h-screen">
      {/* Header Section */}
      <div className=" w-full mx-auto bg-[url(/src/assets/city.jpg)] bg-cover bg-center flex flex-col items-center justify-center">
        <h1 className="text-center pt-50 text-white">
          {isHome
            ? "Connect with me!"
            : "Connect with me - for inquiries, project collaborations, or socially!"}
        </h1>
      </div>
      ...
      <div className="w-3/4 max-w-2xl mx-auto bg-white border border-gray-200 shadow-sm rounded-lg p-10 mb-10">
      ...
      <div className="relative w-3/4 max-w-2xl mx-auto bg-white border border-gray-200 shadow-sm rounded-lg p-10">
