...
export const Project: React.FC<ProjectProps> = ({
	...
	return (
		<section
			ref={sectionRef}
			className={`w-full relative ${allowImageOverflow ? 'py-8 md:py-16 lg:py-44' : 'py-8'}`}
		>
			{/* Mobile Layout */}
			<div
				className={`flex flex-col gap-4 sm:hidden container-margins`}
			>
				{allowImageOverflow ? (
			...
			{allowImageOverflow ? (
				...
				<div className="hidden sm:block container-margins relative">
				...
				// Normal layout
				<div className="hidden sm:block container-margins">
					<div className="flex items-center gap-8 sm:gap-12 md:gap-16 lg:gap-24 xl:gap-40">
						{/* Image Container */}
						<div
							className={`w-2/5 flex ${
								imageLeft ? "order-1 justify-start" : "order-2 justify-end"
							}`}
						>
							<img
								src={imageSrc}
