...
export const Project: React.FC<ProjectProps> = ({
  ...
  return (
    <section ref={sectionRef} className={`w-full relative ${allowImageOverflow ? 'overflow-visible' : 'overflow-hidden'}`}>
      {/* Mobile Layout */}
      <div className={`flex flex-col gap-4 py-8 sm:hidden ${allowImageOverflow ? '' : 'container-margins'}`}>
        {allowImageOverflow ? (
      ...
      {allowImageOverflow ? (
        ...
        <div className="hidden sm:block py-12 relative">
          <div className="container-margins relative">
            {/* Content Container - Always on left for NodeFlow */}
            <div
          ...
          {/* Overflowing Image Container - Fixed to viewport, extending off right side */}
          <div className="absolute top-1/2 -translate-y-1/2 left-1/2 ml-8" style={{width: 'max-content'}}>
            <img
              src={imageSrc}
              alt={title}
